...
class Treatment extends BaseController
{
    ...
    public function store()
    {
        ...
        $treatmentData = [
            ...
            'status' => 'active',
            // Don't set created_at and updated_at - they're auto-generated by the database
            // treatment_id will be auto-generated by the model callback
        ];
    ...
    {
        $treatment = $this->treatmentModel->getTreatmentWithPatientInfo($id);
