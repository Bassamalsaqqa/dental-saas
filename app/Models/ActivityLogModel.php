...
class ActivityLogModel extends Model
{
     ...
     */
    public function getRecentActivities($limit = 20, $userId = null)
    {
    ...
    private function isActivityRead($activityId)
    {
        ...
        // Debug logging
        log_message('debug', "Activity {$activityId} created at: " . $activity['created_at']);
        log_message('debug', "Last read time: " . date('Y-m-d H:i:s', $readTime));
        log_message('debug', "Activity read status: " . ($isRead ? 'READ' : 'UNREAD'));
