...
<!-- Enhanced User Edit with Advanced Design -->
        ...
        <div class="group relative">
            ...
            <div class="relative backdrop-blur-xl bg-white/80 border border-white/30 rounded-2xl shadow-2xl shadow-blue-500/10 group-hover:shadow-blue-500/20 transition-all duration-500 overflow-hidden">
                ...
                <div class="p-8 border-b border-white/20">
                    <div class="flex flex-col lg:flex-row lg:justify-between lg:items-center space-y-4 lg:space-y-0">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <h3 class="text-2xl font-black text-gray-900 group-hover:text-blue-900 transition-colors duration-300">Edit User</h3>
                                <p class="text-gray-600 font-medium">Update user information and access permissions</p>
                            </div>
                        </div>
                ...
                <div class="p-8">
                    ...
                    <form action="<?= base_url('users/' . $user->id . '/update') ?>" method="POST" class="space-y-8">
                        <?= csrf_field() ?>
                                        ...
                                        <div class="group/field relative">
                                            ...
                                            <div class="relative">
                                                <input type="text" id="username" name="username" 
                                                       ...
                                                       value="<?= old('username', $user->username ?? $user->email ?? '') ?>" placeholder="Enter username" required>
                                                <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                                        ...
                                        <div class="group/field relative">
                                            ...
                                            <div class="relative">
                                                <input type="date" id="hire_date" name="hire_date" 
                                                       ...
                                                       value="<?= old('hire_date', $user->hire_date ?? date('Y-m-d')) ?>" required>
                                                <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                        ...
                        <div class="group/section relative">
                            ...
                            <div class="relative backdrop-blur-sm bg-white/60 border border-white/40 rounded-2xl p-8 shadow-lg">
                                ...
                                <div class="space-y-8">
                                    <?php 
                                    // Get the current user's role ID (needed for both regular and admin users)
                                    $currentRoleId = '';
                                    if (!empty($user->roles) && is_array($user->roles)) {
                                        $currentRoleId = $user->roles[0]['role_id'] ?? '';
                                    }
                                    $selectedRole = old('role', $currentRoleId);
                                    ?>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        <?php if ($user->id != 1): ?>
                                        <div class="group/field relative">
                                        ...
                                        <div class="group/field relative">
                                            ...
                                            <div class="relative">
                                                <div class="w-full px-4 py-3 bg-gray-100 border-2 border-gray-300 rounded-xl shadow-lg text-gray-600 flex items-center">
                                                    <i class="fas fa-shield-alt text-blue-600 mr-2"></i>
                                                    <span>Super Admin (System Administrator - Cannot be changed)</span>
                                                </div>
                                                <input type="hidden" name="role" value="<?= $currentRoleId ?>">
                                            </div>
                                            <p class="text-blue-600 text-sm mt-2 flex items-center space-x-1">
                                                <i class="fas fa-info-circle"></i>
                                                <span>The system administrator role cannot be modified</span>
                                            </p>
                                        </div>
                                        <?php endif; ?>
                                    ...
                                    <div class="group/field relative">
                                        ...
                                        <div class="relative">
                                            <select id="status" name="status" 
                                                ...
                                                <option value="active" <?= (old('status', $user->active == 1 ? 'active' : 'inactive') == 'active') ? 'selected' : '' ?>>Active</option>
                                                <option value="inactive" <?= (old('status', $user->active == 1 ? 'active' : 'inactive') == 'inactive') ? 'selected' : '' ?>>Inactive</option>
                                                <option value="suspended" <?= (old('status', $user->active == 1 ? 'active' : 'inactive') == 'suspended') ? 'selected' : '' ?>>Suspended</option>
                                            </select>
                                            <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                                                <i class="fas fa-chevron-down text-gray-400"></i>
                                            </div>
                                ...
                                <div class="group/field relative">
                                    ...
                                    <div class="relative">
                                        <textarea id="address" name="address" rows="3" 
                                                  ...
                                                  placeholder="User's address..."><?= old('address', $user->address ?? '') ?></textarea>
