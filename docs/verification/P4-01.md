...
- **Renderer API Guard:** Verified initController uses renderer()->getData() to read current state.
- **Log Typo Fix:** Corrected log wording to use $displayName in the sidebar user block.
